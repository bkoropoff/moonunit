...
LIBRARY_SETUP=`extract_library_setup < $TMPFILE`
LIBRARY_TEARDOWN=`extract_library_teardown < $TMPFILE`
FIXTURE_SETUP=`extract_fixture_setup < $TMPFILE`
FIXTURE_TEARDOWN=`extract_fixture_teardown < $TMPFILE`
TESTS=`extract_tests < $TMPFILE`
